export const IconMessages = ({ className, height = '2.6rem', width = '2.6rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const IconInbox = ({ className, height = '3.2rem', width = '3.2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const IconSearch = ({ className, height = '2.4rem', width = '2.4rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
